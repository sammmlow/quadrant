...
% ### Feedback control computation and update (using CRPs)            ###
% ###                                                                 ###
...
function [ ATT_BR,   ...
           ...
           OHM_BN,   ...
           INTG_ERR, ...
           CTRL_TORQ ] = ctrl_feedback_crp( TIME,     ... 
                                            STEPD,    ...
                                            STEPC,    ...
                                            Kp,       ...
                                            Ki,       ...
...
DCM_BN = crp_conv2dcm( ATT_BN );
DCM_BR = DCM_BN * DCM_RN';
ATT_BR = dcm_conv2crp( DCM_BR );
...
ATT_BN_DOT = crp_derivative( ATT_BN, OHM_BN );
